...
class Product(models.Model):
    ...
    image9 = ResizedImageField(use_default_size=True, scale=0.5, upload_to=UPLOAD_TO, blank=True)
    image10 = ResizedImageField(size=[500, None], use_default_size=True, upload_to=UPLOAD_TO, blank=True)
    image11 = ResizedImageField(size=[None, 350], use_default_size=True, upload_to=UPLOAD_TO, blank=True)
